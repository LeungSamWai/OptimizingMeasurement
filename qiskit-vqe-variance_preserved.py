...
if __name__ == '__main__':
    ...
    np.savez('qiskit_adam2d/Ratio-std-onfly-newtotal-noisyvqe_adam_shots{}_init_n1-eps0p02-iter500-coslr-stdshot{}-trial{}.npz'.format(args.shots, args.std_shots, args.trial),
